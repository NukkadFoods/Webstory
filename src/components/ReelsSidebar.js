...
const ReelsSidebar = () => {
  ...
  return (
    <>
      ...
      <section className="lg:hidden w-full bg-gray-50 border-t border-gray-200 py-4 px-4">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide">
          {reelsData.length > 0 ? reelsData.map((reel, index) => (
            <a
              ...
              className="flex-none w-32 snap-start group relative rounded-xl overflow-hidden cursor-pointer shadow-sm hover:shadow-lg transition-all duration-300"
              style={{ height: '180px' }}
            >
              <img
